...
class Captcha
{
	...
	public function check_captcha()
	{
		...
		if ($captcha == $_SESSION['captcha']) {
			...
			<div style="font-family:Poppins; margin-top:435px; text-align:center;margin-left:570px;margin-right:875px;" class="alert alert-success" role="alert">The Captcha you entered was correct! Redirecting you to the home page...</div>';
